...
app.put('/post',uploadMiddleware.single('file'), async(req,res)=>{
   ...
   jwt.verify(token,secret,{},async(err,info)=>{
      ...
      const isAuthor =JSON.stringify(postDoc.author)===JSON(info.id);
      if(!isAuthor){
...
//localdb=mongodb://127.0.0.1:27017/blog-app
